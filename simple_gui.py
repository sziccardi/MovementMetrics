...
graph_size = (475, 475)
image_size = (475, 475)
colors = ["green", "coral", "aquamarine4", "DarkOrange1", "blue", "goldenrod", "purple", "brown", "grey", "gold", "black", "red", "cadet blue", "cornflower blue", "DeepPink", "olive drab"]
window = None
    ...
    if graph_type == GraphType.HEAT_MAP:
        ...
        for i in range(len(data)):
            ...
            for j in range(len(data[i])):
                y = j - len(data[i])/2
                color_select = int((data[i][j]/color_range)*50.0)
    ...
    while current_layout:
        ...
        #lets run plotting!
            ...
            if plot_type[0] == "relative position" or plot_type[0] == "point cloud" or plot_type[0] == "centroid of motion" or plot_type[0] == "distance from center" or plot_type[0] == "normalized distance from center":
                ...
                create_two_plots([graph, graph2], data, labels, window["-PLOT LEGEND-"], ax_labels, plot_type[0] == "position spectrum", GraphType.LINE_GRAPH)
