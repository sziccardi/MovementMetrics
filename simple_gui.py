...
def create_basic_plot(graph, data, data_labels, legend, axes_labels, line_plot):
    #ax_lims order = [x_max_0, x_max_1, y_max_0, y_max_1, x_min_0, x_min_1, y_min_0, y_min_1]
...
def create_two_plots(graphs, data, data_labels, legend, axes_labels, box_n_whisk, line_plot):
