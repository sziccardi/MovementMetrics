...
# keypoint_names = ['nose', 'inner left eye',	'center left eye', 'outer left eye', 'inner right eye', 'center right eye', 'outer right eye', 'left ear', 'left corner mouth', 'right corner mouth', 'left shoulder', 'right shoulder', 'left elbow', 'right elbow', 'left wrist', 'right wrist', 'left pinky finger', 'right pinky finger', 'left index finger', 'right index finger', 'left thumb', 'right thumb', 'left hip', 'right hip', 'left knee', 'right knee', 'left ankle', 'right ankle', 'left heel', 'right heel', 'left big toe', 'right big toe']
#keypoint_names = ['nose', 'left eye (inner)', 'left eye', 'left eye (outer)', 'right eye (inner)', 'right eye', 'right eye (outer)', 'left ear', 'right ear', 'mouth (left)', 'mouth (right)', 'left shoulder', 'right shoulder', 'left elbow', 'right elbow', 'left wrist', 'right wrist', 'left pinky finger', 'right pinky finger', 'left index finger', 'right index finger', 'left thumb', 'right thumb', 'left hip', 'right hip', 'left knee', 'right knee', 'left ankle', 'right ankle', 'left heel', 'right heel', 'left big toe', 'right big toe']
keypoint_names = ["nose", "left eye (inner)", "left eye", "left eye (outer)", "right eye (inner)", "right eye","right eye (outer)", "left ear", "right ear", "mouth (left)", "mouth (right)", "left shoulder", "right shoulder", "left elbow", "right elbow", "left wrist", "right wrist", "left pinky", "right pinky", "left index", "right index","left thumb", "right thumb", "left hip", "right hip", "left knee", "right knee", "left ankle", "right ankle", "left heel", "right heel", "left foot index", "right foot index", "right hand wrist","right thumb base", "right thumb 1", "right thumb 2", "right thumb tip", "right index base", "right index 1", "right index 2", "right index tip", "right middle base", "right middle 1", "right middle 2", "right middle tip", "right ring base", "right ring 1", "right ring 2", "right ring tip", "right pinky base", "right pinky 1", "right pinky 2", "right pinky tip", "left hand wrist","left thumb base", "left thumb 1", "left thumb 2", "left thumb tip", "left index base", "left index 1", "left index 2", "left index tip", "left middle base", "left middle 1", "left middle 2", "left middle tip", "left ring base", "left ring 1", "left ring 2", "left ring tip", "left pinky base", "left pinky 1", "left pinky 2", "left pinky tip"]
...
def GetRelativePositionData(data, keypoints):
    ...
    labels = []
    processed_data = []
    key_list = [i for i in range(np_vals.shape[0])]
...
def GetRelativePositionOverTimeData(data, keypoints, fps, vel_blocks):
    ...
    np_vals = data #np.array(data_list)
